...
from numpy import arange,unique,sign,column_stack,zeros,where #,full
from rasterio import open as open_file
from multiprocessing import Pool, cpu_count
from pvlib import solarposition,atmosphere,iotools
from os import remove,path
from math import sin,cos,floor,tan
...
class TID:
    def __init__(self,region,file_location:str)->None:
        ...
        if region.latitude>60:
            ...
            self.Weather_dataframe=iotools.read_psm3(region.weather_file)[1] # https://pvlib-python.readthedocs.io/en/stable/generated/pvlib.iotools.read_psm3.html
    ...
    def annual(self)->DataFrame:
        ...
        output_file=self.file_location+r'\Inputs\Timeindaylight_annual.tif'
    ...
    # Timeindaylight_hourly=open_file("//w-var-a106532/D/scidata/REN1/Varennes_PV_potential_buildings/Python_and_QGIS_outputs/Timeindaylight_hourly.tif")
