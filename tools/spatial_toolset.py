...
class spatial_toolset:
    def crop_vector(self,input_file, clipping_file,output_file):
        """
    ...
    def crop_raster(self,cropped_file,input_file,boundary):
        """
        ...
        # upper_left_x = 311319.76
        # upper_left_y = 5061073.61
        # lower_right_x = 311341.61
        # lower_right_y = 5061053.95
    ...
    def rasterize_polygon(self,dsm,shp,out_raster_file_name,pixel_size):
        """
