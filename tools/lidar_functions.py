...
class lidar_functions:
    def __init__(self, city,directory,laszip_location):
        self.city=city
        self.directory=directory
        self.laszip_location=laszip_location

    def total_num_files(self,input_dir): # Gets the number of laz files in an input directory
        """
...
.       processed_files : string
    ...
    def find_laz_files(self,input_dir, processed_files, max_num = 1): # Finds a specific number of laz files in an input directory
        """
        Function to find laz files to las files in a specified directory
        and return the list of names with extention .laz in the diectory
...
.       processed_files : string
    ...
    def parallelize_zip(self,in_files_list): # Converts laz to las using the laszip tool in LAStools 
        """
...
.
    ...
    def fix_las_QGIS(self,filename):
        """
    ...
    def lidar_info(self,input_file,output_file):
        """
    ...
    def run_lidar_info(self,output_density):
        """
    ...
    def extract(self,html_location,output_location):
        """
...
if __name__=="__main__":
    city='Calgary'
    directories='//w-var-a106532/D/scidata/REN1/Varennes_PV_potential_buildings/'
    laszip_location=r"\\w-var-a106532\D\scidata\REN1\Varennes_PV_potential_buildings\Laz2Las\laszip.exe"
    output_density=r'C:\Users\egaucher\Documents\Inputs\density.xlsx'
